                ...
                >
                  ...
                  <Flex p="6" gap="5" align="center">
                    ...
                    <Flex py="6" align="center" gap="1">
                      <Heading size="5">beautyrelease</Heading>
                    </Flex>
                  </Container>
                </header>
                ...
                >
                        ...
                        <React.Fragment key={label}>
                          ...
                          <table className={styles.table}>
                            <thead>
                              <tr>
                                <ColumnHeaderCell />
                                {switchPropDefs.variant.values.map(
                                  (variant) => (
                  ...
                  <DocsSection title="Spinner">
                    <Grid gap="4">
                      ...
                      <Flex gap="4" align="center">
                        <TextField.Root
                          defaultValue="horsebatterystaple"
                          type="password"
                          size="1"
                        >
                          <TextField.Slot>
                        ...
                        <React.Fragment key={label}>
                          ...
                          <table className={styles.table}>
                            <thead>
                              <tr>
                                <ColumnHeaderCell />
                                {checkboxPropDefs.variant.values.map(
                                  (variant) => (
                                    <ColumnHeaderCell key={variant}>
                                      {variant}
                                    </ColumnHeaderCell>
                    ...
                    <Grid columns="2" gap="9">
                      <div>
                        <table className={styles.table}>
                          ...
                          <tbody>
                            {checkboxGroupRootPropDefs.variant.values.map(
                              (variant) => (
                                <React.Fragment key={variant}>
                                  {[variant, "+ high-contrast"].map((label) => (
                                    <tr key={label}>
                        ...
                        <table className={styles.table}>
                          <tbody>
                            {checkboxGroupRootPropDefs.size.values.map(
                              (size) => (
                                <tr key={size}>
                                  <RowHeaderCell>size {size}</RowHeaderCell>
                                  <td style={{ width: "100%" }}>
                                    ...
                                    >
                                      ...
                                      <CheckboxGroup.Item value="violet">
                                        Violet
                                      </CheckboxGroup.Item>
                                    </CheckboxGroup.Root>
                                  </td>
                  ...
                  <DocsSection title="CheckboxCards">
                    ...
                    <table className={styles.table}>
                      <tbody>
                        {checkboxCardsRootPropDefs.size.values.map(
                          (size, index) => (
                            <tr key={size}>
                              <RowHeaderCell>size {size}</RowHeaderCell>
                              <td>
                          ...
                          <table className={styles.table}>
                            ...
                            <tbody>
                              {values.map((color) => (
                                <tr key={color}>
                                  <RowHeaderCell>{color}</RowHeaderCell>
                                  {radioPropDefs.variant.values.map(
                                    (variant) => (
                                      <td key={variant}>
                                        <Flex gap="2">
                                          <Radio
                  ...
                  <DocsSection title="RadioCards">
                    ...
                    <table className={styles.table}>
                      <tbody>
                        {radioCardsRootPropDefs.size.values.map(
                          (size, index) => (
                            <tr key={size}>
                              <RowHeaderCell>size {size}</RowHeaderCell>
                              <td>
                        ...
                        {textFieldRootPropDefs.variant.values.map((variant) => (
                          <React.Fragment key={variant}>
                            {[variant, "+ gray"].map((label) => (
                              <tr key={label}>
                                <RowHeaderCell>{label}</RowHeaderCell>
                                {textFieldRootPropDefs.size.values.map(
                                  (size) => (
                                    <td key={size}>
                                      <Flex direction="column" gap="2">
                                        <TextField.Root
                  ...
                  <DocsSection title="Typography">
                    <Flex direction="column" gap="5" style={{ maxWidth: 688 }}>
                      ...
                      <Heading size="7">
                        The goal of typography is to relate font size,
                        line height, and line width in a proportional way
                      </Heading>
                      ...
                      <Text color="gray" size="5">
                        The goal of typography is to relate font size,
                        line height, and line width in a proportional way that
                      ...
                      <Grid columns="2" gap="5" mb="7">
                        <Box>
                          ...
                          <Text as="p" size="3">
                            The goal of typography is to relate font size,
                            line height, and line width in a proportional way
                            that maximizes beauty and makes reading easier and
                            more pleasant.
                          </Text>
                        </Box>
                        <Box>
                  ...
                  <DocsSection title="Grid">
                    ...
                    <Grid gap="3" columns="4">
                      ...
                      <Grid
                        gap="3"
                        columns={{ xs: "3", md: "1fr 1fr 2fr", lg: "3" }}
                      >
                        {Array.from(Array(3).keys()).map((i) => (
                          <Box
                            key={i}
                      ...
                      <Box style={{ width: 400 }}>
                        ...
                        <Flex gap="3" align="center" mt="6" wrap="wrap">
                          ...
                          >
                            The goal of typography is to relate font size,
                            line height, and line width in a proportional way
                            that maximizes <Text highContrast>beauty</Text> and
                            makes reading easier and more pleasant. The question
                            is: What proportion(s) will give us the best
                            results?
                          </Blockquote>
                        ...
                        <Flex gap="3" align="center" mt="6" wrap="wrap">
                          ...
                          <Skeleton>
                            ...
                            >
                              The goal of typography is to relate font size,
                              line height, and line width in a proportional way
                              that maximizes <Text highContrast>beauty</Text>{" "}
                              and makes reading easier and more pleasant. The
                              question is: What proportion(s) will give us the
                              best results?
                            </Blockquote>
                          </Skeleton>
                  ...
                  <DocsSection title="DataList">
                    <Flex gap="4" align="center">
                      <Tabs.Root defaultValue="specimen">
                        <Tabs.List size="2">
                          ...
                          <Tabs.Trigger value="all-orientations">
                            All orientations
                          </Tabs.Trigger>
                          <Tabs.Trigger value="all-sizes">
                            All sizes
                          </Tabs.Trigger>
                        </Tabs.List>
                            ...
                            <DataList.Root>
                              ...
                              <DataList.Item>
                                ...
                                <DataList.Value>
                                  ...
                                  adipiscing elit. Nulla ac nisl et libero
                                  ultricies viverra quis vitae quam. Proin a
                                  feugiat metus.
                                </DataList.Value>
                              </DataList.Item>
                              <DataList.Item>
                        ...
                        <Tabs.Content value="all-orientations">
                          <Box my="6">
                            <table className={styles.table}>
                              <tbody>
                                {dataListRootPropDefs.orientation.values.map(
                                  (orientation) => (
                                    <tr key={orientation}>
                                      <RowHeaderCell>
                                        {upperFirst(orientation)}
                                      </RowHeaderCell>
                        ...
                        <Tabs.Content value="all-sizes">
                          <Box my="6">
                            <table className={styles.table}>
                              <tbody>
                                {dataListRootPropDefs.size.values.map(
                                  (size) => (
                                    <tr key={size}>
                                      <RowHeaderCell>{`Size ${size}`}</RowHeaderCell>
                                      <td style={{ textAlign: "left" }}>
                    ...
                    <Text as="p" my="5">
                      <Code>color</Code> can be set per{" "}
                      <Code>DataListLabel</Code> instance:
                    </Text>
                    ...
                    <Text as="p" my="5">
                      <Code>width</Code> can be set per{" "}
                      <Code>DataListLabel</Code> instance:
                    </Text>
                  ...
                  <DocsSection title="Segmented Control">
                    <table className={styles.table}>
                      <thead>
                        <tr>
                          <ColumnHeaderCell />
                          {segmentedControlRootPropDefs.size.values.map(
                            (size) => (
                              <ColumnHeaderCell key={size}>
                                size {size}
                              </ColumnHeaderCell>
