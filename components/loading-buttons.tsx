  ...
  return (
    <Flex direction="column" gap="5">
      ...
      <Text as="p">
        ...
        adipisicing elit. Eum veritatis, cupiditate inventore recusandae
        sapiente corporis non similique facere esse praesentium? Dolorum
        pariatur omnis doloremque unde nam rem ipsa velit vitae.
      </Text>
    </Flex>
  );
}

function mapButtonSizeToIconSize(
